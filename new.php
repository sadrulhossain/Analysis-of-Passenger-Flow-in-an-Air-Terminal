...
<head>
	<meta charset="UTF-8">
	<title>Analysis of flights' Flow in an Airport Terminal</title>
...
<body style="background:#45597f;">
	<div class="container-fluid" style="height:auto; padding:0; margin:15px auto; width:90%">
		<div class="well">
			<div class="well">
				<h3><strong><center>Analysis of flights' Flow in an Airport Terminal</center></strong></h3>
			</div>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="well" >
						<form action="new.php" method="POST" name="simulate">
